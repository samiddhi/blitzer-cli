...
The architecture was refactored to make adding new languages much more dynamic and extensible. To add support for a new language:
...
5. Provide a SQLite database with lemmatization data at =~/.config/blitzer/[lang_code]_lexicon.db=

This design removes the need to modify core files when adding new languages, making the system much more extensible.
